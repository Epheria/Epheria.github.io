...
<div class="gc-gen" style="margin:2rem 0;overflow-x:auto;">
  <div class="gc-gen-section gc-gen-net">
    <div class="gc-gen-title">.NET 세대별 GC</div>
    <div class="gc-gen-grid">
      <div class="gc-gen-card gc-gen-c0"><div class="gc-gen-name">Gen0</div><div class="gc-gen-desc">새 객체 · 빈번 수집</div><div class="gc-gen-time">~0.1ms</div></div>
      <div class="gc-gen-card gc-gen-c1"><div class="gc-gen-name">Gen1</div><div class="gc-gen-desc">1회 생존 · 가끔 수집</div><div class="gc-gen-time">~1ms</div></div>
      <div class="gc-gen-card gc-gen-c2"><div class="gc-gen-name">Gen2</div><div class="gc-gen-desc">오래된 객체 · 드물게</div><div class="gc-gen-time">~10ms</div></div>
    </div>
  </div>
  <div class="gc-gen-vs">VS</div>
  <div class="gc-gen-section gc-gen-unity">
    <div class="gc-gen-title">Unity Boehm GC</div>
    <div class="gc-gen-mono"><div class="gc-gen-name">전체 힙 (단일 세대)</div><div class="gc-gen-desc">새 객체 + 오래된 객체 + 모든 것 — 매번 전체 스캔<br>비용 ∝ 힙 크기 · 힙이 커질수록 GC 시간이 선형으로 증가</div></div>
  </div>
</div>
<style>
...
<div class="gc-frag" style="margin:2rem 0;overflow-x:auto;">
  <div class="gc-frag-row">
    <div class="gc-frag-head"><span class="gc-frag-step">1</span>초기 상태 — 8개 객체 적재, 4칸 여유</div>
  ...
  <div class="gc-frag-row">
    <div class="gc-frag-head"><span class="gc-frag-step">2</span>B/D/E/G 해제 — 구멍이 흩어지며 단편화 발생</div>
  ...
  <div class="gc-frag-fail"><span class="gc-frag-step danger">3</span><strong>5칸 연속 배열 할당 시도</strong> — 구멍 합 4칸 + 끝 4칸 = 총 8칸 여유. 그러나 <span class="gc-frag-bad">가장 긴 연속 영역은 4칸뿐</span> → 할당 실패, 힙 확장 발생 (Unity는 OS에 메모리를 반환하지 않음)</div>
  <div class="gc-frag-legend"><span class="gc-frag-cell used sm">사용 중</span><span class="gc-frag-cell hole sm"></span>해제된 구멍<span class="gc-frag-cell free sm"></span>미사용 영역</div>
</div>
<style>
.gc-frag-row{display:grid;grid-template-columns:230px 1fr;align-items:center;gap:1rem;margin-bottom:.6rem}
...
<div class="gc-tl" style="margin:2rem 0;overflow-x:auto;">
  <div class="gc-tl-block">
    <div class="gc-tl-head"><span class="gc-tl-tag bad">통상 GC · Stop-the-World</span><span class="gc-tl-total">총 21.6ms · <strong>프레임 드롭</strong></span></div>
    <div class="gc-tl-track">
      <span class="gc-tl-seg upd" style="width:30%">Update<br><small>~5ms</small></span>
      <span class="gc-tl-seg gc-big" style="width:40%">GC 5ms<br><small>↑ 메인 스레드 정지</small></span>
      <span class="gc-tl-seg rnd" style="width:30%">Render<br><small>~5ms</small></span>
    </div>
  </div>
  <div class="gc-tl-block">
    <div class="gc-tl-head"><span class="gc-tl-tag good">Incremental GC · 분산 처리</span><span class="gc-tl-total">프레임당 16.6ms 유지 · <strong>드롭 없음</strong></span></div>
    <div class="gc-tl-multi">
      <div class="gc-tl-mini"><span class="gc-tl-label">프레임 1</span><div class="gc-tl-track-mini"><span class="gc-tl-seg upd" style="width:80%">Update</span><span class="gc-tl-seg gc-mini" style="width:20%">GC 1ms</span></div></div>
      <div class="gc-tl-mini"><span class="gc-tl-label">프레임 2</span><div class="gc-tl-track-mini"><span class="gc-tl-seg upd" style="width:80%">Update</span><span class="gc-tl-seg gc-mini" style="width:20%">GC 1ms</span></div></div>
      <div class="gc-tl-mini"><span class="gc-tl-label">프레임 3</span><div class="gc-tl-track-mini"><span class="gc-tl-seg upd" style="width:80%">Update</span><span class="gc-tl-seg gc-mini" style="width:20%">GC 1ms</span></div></div>
    </div>
  </div>
</div>
<style>
...
<div class="gc-inc" style="margin:2rem 0;">
  <div class="gc-inc-grid">
    <div class="gc-inc-side good">
      <div class="gc-inc-head"><span class="gc-inc-icon">✓</span>해결하는 것</div>
      <ul class="gc-inc-list">
        <li>GC 스파이크를 분산하여 <strong>프레임 드롭 완화</strong></li>
      </ul>
    </div>
    <div class="gc-inc-side bad">
      <div class="gc-inc-head"><span class="gc-inc-icon">✗</span>해결하지 <em>않는</em> 것</div>
      <ul class="gc-inc-list">
        <li>GC의 <strong>총 비용</strong> (같은 작업을 여러 프레임에 나눌 뿐)</li>
        <li><strong>힙 단편화</strong> (여전히 non-compacting)</li>
        <li>힙 크기에 비례하는 <strong>스캔 비용</strong></li>
        <li><strong>managed 할당 자체</strong>의 비용</li>
      </ul>
    </div>
  </div>
</div>
