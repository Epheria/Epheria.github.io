...
<div class="gc-gen" style="margin:2rem 0;overflow-x:auto;">
  <div class="gc-gen-section gc-gen-net">
    <div class="gc-gen-title">.NET 世代別GC</div>
    <div class="gc-gen-grid">
      <div class="gc-gen-card gc-gen-c0"><div class="gc-gen-name">Gen0</div><div class="gc-gen-desc">新しいオブジェクト · 頻繁</div><div class="gc-gen-time">~0.1ms</div></div>
      <div class="gc-gen-card gc-gen-c1"><div class="gc-gen-name">Gen1</div><div class="gc-gen-desc">1回生存 · たまに</div><div class="gc-gen-time">~1ms</div></div>
      <div class="gc-gen-card gc-gen-c2"><div class="gc-gen-name">Gen2</div><div class="gc-gen-desc">古いオブジェクト · 稀</div><div class="gc-gen-time">~10ms</div></div>
    </div>
  </div>
  <div class="gc-gen-vs">VS</div>
  <div class="gc-gen-section gc-gen-unity">
    <div class="gc-gen-title">Unity Boehm GC</div>
    <div class="gc-gen-mono"><div class="gc-gen-name">全ヒープ（単一世代）</div><div class="gc-gen-desc">新しい + 古い + すべて — 毎回全体をスキャン<br>コスト ∝ ヒープサイズ · ヒープが大きいほどGC時間が線形に増加</div></div>
  </div>
</div>
<style>
...
<div class="gc-frag" style="margin:2rem 0;overflow-x:auto;">
  <div class="gc-frag-row">
    <div class="gc-frag-head"><span class="gc-frag-step">1</span>初期状態 — 8個のオブジェクト、4セル空き</div>
  ...
  <div class="gc-frag-row">
    <div class="gc-frag-head"><span class="gc-frag-step">2</span>B/D/E/G解放後 — 穴が散在し断片化</div>
  ...
  <div class="gc-frag-fail"><span class="gc-frag-step danger">3</span><strong>5セル連続の配列割り当て試行</strong> — 穴4セル + 末尾4セル = 計8セル空き。しかし<span class="gc-frag-bad">最長の連続領域は4セルのみ</span> → 割り当て失敗、ヒープが拡張（UnityはOSにメモリを返却しない）</div>
  <div class="gc-frag-legend"><span class="gc-frag-cell used sm">使用中</span><span class="gc-frag-cell hole sm"></span>解放された穴<span class="gc-frag-cell free sm"></span>未使用</div>
</div>
<style>
.gc-frag-row{display:grid;grid-template-columns:260px 1fr;align-items:center;gap:1rem;margin-bottom:.6rem}
...
<div class="gc-tl" style="margin:2rem 0;overflow-x:auto;">
  <div class="gc-tl-block">
    <div class="gc-tl-head"><span class="gc-tl-tag bad">通常GC · Stop-the-World</span><span class="gc-tl-total">合計21.6ms · <strong>フレームドロップ</strong></span></div>
    <div class="gc-tl-track">
      <span class="gc-tl-seg upd" style="width:30%">Update<br><small>~5ms</small></span>
      <span class="gc-tl-seg gc-big" style="width:40%">GC 5ms<br><small>↑ メインスレッド停止</small></span>
      <span class="gc-tl-seg rnd" style="width:30%">Render<br><small>~5ms</small></span>
    </div>
  </div>
  <div class="gc-tl-block">
    <div class="gc-tl-head"><span class="gc-tl-tag good">Incremental GC · 分散処理</span><span class="gc-tl-total">フレームあたり16.6ms維持 · <strong>ドロップなし</strong></span></div>
    <div class="gc-tl-multi">
      <div class="gc-tl-mini"><span class="gc-tl-label">フレーム1</span><div class="gc-tl-track-mini"><span class="gc-tl-seg upd" style="width:80%">Update</span><span class="gc-tl-seg gc-mini" style="width:20%">GC 1ms</span></div></div>
      <div class="gc-tl-mini"><span class="gc-tl-label">フレーム2</span><div class="gc-tl-track-mini"><span class="gc-tl-seg upd" style="width:80%">Update</span><span class="gc-tl-seg gc-mini" style="width:20%">GC 1ms</span></div></div>
      <div class="gc-tl-mini"><span class="gc-tl-label">フレーム3</span><div class="gc-tl-track-mini"><span class="gc-tl-seg upd" style="width:80%">Update</span><span class="gc-tl-seg gc-mini" style="width:20%">GC 1ms</span></div></div>
    </div>
  </div>
</div>
<style>
...
<div class="gc-inc" style="margin:2rem 0;">
  <div class="gc-inc-grid">
    <div class="gc-inc-side good">
      <div class="gc-inc-head"><span class="gc-inc-icon">✓</span>解決すること</div>
      <ul class="gc-inc-list">
        <li>GCスパイクを分散して<strong>フレームドロップを緩和</strong></li>
      </ul>
    </div>
    <div class="gc-inc-side bad">
      <div class="gc-inc-head"><span class="gc-inc-icon">✗</span>解決し<em>ない</em>こと</div>
      <ul class="gc-inc-list">
        <li>GCの<strong>総コスト</strong>（同じ作業を複数フレームに分けるだけ）</li>
        <li><strong>ヒープ断片化</strong>（依然としてnon-compacting）</li>
        <li>ヒープサイズに比例する<strong>スキャンコスト</strong></li>
        <li><strong>managed割り当て自体</strong>のコスト</li>
      </ul>
    </div>
  </div>
</div>
