...
![AI 코드 검토 흐름](/assets/img/post/cs/excalidraw-04-ai-code-review.png)
...
![보안 반복 개선의 역설](/assets/img/post/cs/excalidraw-05-security-iteration.png)
...
![소프트웨어 복잡성 — Brooks의 분류](/assets/img/post/cs/excalidraw-06-software-complexity.png)
...
![개발자 채용 시장의 양극화](/assets/img/post/cs/excalidraw-07-job-market.png)
...
![CS 로드맵 — 게임 프로그래머를 위한 7단계](/assets/img/post/cs/excalidraw-08-cs-roadmap.png)
